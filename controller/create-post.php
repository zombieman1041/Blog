<?php
	...
	$query = $connection->query("INSERT INTO posts SET title = '$title', post = '$post'"); //creates a table by query with a title using the var title and a post with a var post
